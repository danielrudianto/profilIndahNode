...
router.get("/:reference", (0, express_validator_1.param)("reference").notEmpty().withMessage(error_list_1.default["Parameter error"]), item_price_controller_1.default.fetchByReference);
