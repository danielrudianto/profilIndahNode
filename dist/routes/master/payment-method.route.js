...
router.delete("/:id", (0, express_validator_1.param)("id").not().isEmpty().withMessage(error_list_1.default["Parameter error"]), (0, express_validator_1.param)("id").isInt({ min: 1 }).withMessage(error_list_1.default["Parameter error"]), auth_helper_1.administratorMiddleware, paymentMethodController.delete);
