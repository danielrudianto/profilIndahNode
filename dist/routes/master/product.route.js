...
router.put("/active", auth_helper_1.administratorMiddleware, (0, express_validator_1.body)("id").exists().isNumeric().withMessage(error_list_1.default["Parameter error"]), error_helper_1.default.intercept, product_controller_1.default.active);
router.put("/", auth_helper_1.administratorMiddleware, (0, express_validator_1.body)("id").exists().isNumeric().withMessage(error_list_1.default["Parameter error"]), (0, express_validator_1.body)("reference").exists().withMessage(error_list_1.default["Parameter error"]), (0, express_validator_1.body)("reference").notEmpty().withMessage(error_list_1.default["Parameter error"]), (0, express_validator_1.body)("description").exists().withMessage(error_list_1.default["Parameter error"]), (0, express_validator_1.body)("description").notEmpty().withMessage(error_list_1.default["Parameter error"]), (0, express_validator_1.body)("brand").exists().withMessage(error_list_1.default["Parameter error"]), (0, express_validator_1.body)("type").exists().withMessage(error_list_1.default["Parameter error"]), (0, express_validator_1.body)("minimum_stock")
    .isFloat({ min: 0 })
    .withMessage(error_list_1.default["Parameter error"]), (0, express_validator_1.body)("unit").exists().withMessage(error_list_1.default["Parameter error"]), error_helper_1.default.intercept, product_controller_1.default.update);
...
router.post("/price-purchase", (0, express_validator_1.body)("item_id").notEmpty().withMessage(error_list_1.default["Parameter error"]), product_price_purchase_controller_1.default.fetchByItemID);
router.delete("/:id", auth_helper_1.administratorMiddleware, (0, express_validator_1.param)("id").notEmpty().isNumeric().withMessage(error_list_1.default["Parameter error"]), error_helper_1.default.intercept, product_controller_1.default.delete);
