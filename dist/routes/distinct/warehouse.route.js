...
router.post("/product-stock", (0, express_validator_1.body)("keyword").exists().withMessage(error_list_1.default["Keyword is required"]), (0, express_validator_1.body)("page").notEmpty().withMessage(error_list_1.default["Page is required"]), (0, express_validator_1.body)("page")
    .isInt({
    min: 0,
})
