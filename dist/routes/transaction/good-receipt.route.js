...
router.post("/", auth_helper_1.putriForbiddenMiddleware, (0, express_validator_1.body)("date").notEmpty().withMessage(error_list_1.default["Date required"]), (0, express_validator_1.body)("name").notEmpty().withMessage(error_list_1.default["Name required"]), (0, express_validator_1.body)("company_id").notEmpty().withMessage(error_list_1.default["Company ID required"]), (0, express_validator_1.body)("supplier_id").notEmpty().withMessage(error_list_1.default["Supplier ID required"]), (0, express_validator_1.body)("good_receipt")
    .notEmpty()
    ...
    .isFloat({ min: 0 })
    .withMessage(error_list_1.default["Quantity must be numeric"]), error_helper_1.default.intercept, goodReceiptController.create);
router.post("/", auth_helper_1.superadministratorMiddleware, (0, express_validator_1.body)("id").notEmpty().withMessage(error_list_1.default["ID is required"]), (0, express_validator_1.body)("date").notEmpty().withMessage(error_list_1.default["Date required"]), (0, express_validator_1.body)("name").notEmpty().withMessage(error_list_1.default["Invoice name required"]), (0, express_validator_1.body)("faktur").exists().withMessage(error_list_1.default["Tax invoice required"]), (0, express_validator_1.body)("invoice_name").notEmpty().withMessage(error_list_1.default["Name required"]), (0, express_validator_1.body)("company_id").notEmpty().withMessage(error_list_1.default["Company ID required"]), (0, express_validator_1.body)("supplier_id").notEmpty().withMessage(error_list_1.default["Supplier ID required"]), (0, express_validator_1.body)("good_receipt")
    .notEmpty()
    .withMessage(error_list_1.default["Good receipt required"]), (0, express_validator_1.body)("good_receipt")
    .isArray()
    .withMessage(error_list_1.default["Good receipt must be array"]), (0, express_validator_1.body)("good_receipt.*.product_id")
