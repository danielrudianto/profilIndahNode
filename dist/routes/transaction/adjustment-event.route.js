...
router.post("/approve/:id", auth_helper_1.superadministratorMiddleware, (0, express_validator_1.param)("id").notEmpty().withMessage(error_list_1.default["Parameter error"]), (0, express_validator_1.param)("id").isInt({ min: 0 }).withMessage(error_list_1.default["Parameter error"]), error_helper_1.default.intercept, adjustment_event_controller_1.default.approve);
router.post("/disapprove/:id", auth_helper_1.superadministratorMiddleware, (0, express_validator_1.param)("id").notEmpty().withMessage(error_list_1.default["Parameter error"]), (0, express_validator_1.param)("id").isInt({ min: 0 }).withMessage(error_list_1.default["Parameter error"]), error_helper_1.default.intercept, adjustment_event_controller_1.default.disapprove);
router.get("/unconfirmed", adjustment_event_controller_1.default.fetchUnconfirmed);
router.get("/code/:id", (0, express_validator_1.param)("id").notEmpty().withMessage(error_list_1.default["Parameter error"]), error_helper_1.default.intercept, adjustment_event_controller_1.default.fetchCodeByID);
