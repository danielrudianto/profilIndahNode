...
router.post("/", body("name").not().isEmpty().withMessage("Mohon isikan nama supplier."), body("address").not().isEmpty().withMessage("Mohon isikan alamat supplier"), SupplierController.create);
