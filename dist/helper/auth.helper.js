...
exports.putriForbiddenMiddleware = exports.superadministratorMiddleware = exports.administratorMiddleware = exports.authMiddlewareRole = exports.authMiddleware = void 0;
...
const authMiddlewareRole = (req, res, next) => {
    var _a;
    let tokenHeader = (_a = req.headers["authorization"]) === null || _a === void 0 ? void 0 : _a.toString();
    if (!tokenHeader || tokenHeader.split(" ")[0] !== "Bearer") {
        return res.status(401).json({
...
exports.authMiddlewareRole = authMiddlewareRole;
