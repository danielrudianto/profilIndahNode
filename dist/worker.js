...
const product_brand_service_1 = require("./services/product-brand.service");
const good_receipt_service_1 = require("./services/good-receipt.service");
...
const productBrandService = new product_brand_service_1.ProductBrandService(new product_brand_repository_1.ProductBrandRepository(database_helper_1.prisma));
const goodReceiptService = new good_receipt_service_1.GoodReceiptService(new good_receipt_repository_1.GoodReceiptRepository(database_helper_1.prisma), new stock_in_repository_1.StockInRepository(database_helper_1.prisma));
const productPackageService = new package_service_1.ProductPackageService(new product_package_repository_1.ProductPackageRepository(database_helper_1.prisma));
