...
class PromotionRepository {
    ...
    async fetchSalesResult(productID, startDate, endDate) {
        ...
        return result.map((x) => {
            return {
                ...
                customer: x.sales_invoice_code.customer == null
                    ? "Retail"
    ...
    async fetchPurchaseReport(productID, supplierID, startDate, endDate) {
