...
exports.ProductSalesPriceController = void 0;
...
exports.ProductSalesPriceController = ProductSalesPriceController;
_a = ProductSalesPriceController;
/**
 ...
 */
ProductSalesPriceController.fetchAll = (req, res) => {
    // const date = new Date();
...
ProductSalesPriceController.fetchByID = (req, res) => {
    // const id = Number(req.params.id);
...
ProductSalesPriceController.fetchByIDV2 = (req, res) => {
    // const id = Number(req.params.id);
...
ProductSalesPriceController.updateV2 = (req, res) => {
    // const data = req.body;
 ...
 * @param res
 */
ProductSalesPriceController.fetch = (req, res) => {
 ...
 * @param res
 */
ProductSalesPriceController.updateByID = (req, res) => {
...
ProductSalesPriceController.updateByIDV2 = (req, res) => {
 ...
 * @param res
 */
ProductSalesPriceController.createBulk = (req, res) => {
 ...
 * @param res
 */
ProductSalesPriceController.fetchByItemID = (req, res) => {
    // const item_id = req.body.item_id;
    // const item_unit_id = req.body.item_unit_id;
    // ItemPriceModel.fetchByItemID(item_id, item_unit_id)
    //   .then((result) => {
 ...
 * @param res
 */
ProductSalesPriceController.fetchFormat = async (req, res) => {
