...
ReportController.fetchSalesItemDailyReport = (req, res) => {
    ...
    const type = req.body.type;
    const group = req.body.group;
    item_model_1.ItemModel.fetchValueByBrandTypeDaily(type, day, month, year).then(([result, types]) => __awaiter(void 0, void 0, void 0, function* () {
        mongo_stock_card_model_1.mongoStockCardModel
            .aggregate([
            {
                $match: {
                ...
                return {
                    ...
                    items: result
                        ...
                        return {
                            ...
                            bill_output: Number(y.billQuantity),
                            sales_return: Number(y.salesReturnQuantity),
                            initialStock: stockIndex == -1 ? 0 : stocks[stockIndex].currentStock,
                        };
                    }),
                };
            });
...
ReportController.fetchSalesDashboardV2 = (req, res) => {
    Promise.all([
        ...
        bill_code_model_1.default.fetchOlderSales(),
        deposit_model_1.default.countActive(),
        promotion_model_1.default.countActive(),
    ]).then(([[billCurrentValue, billPreviousValue], [billCurrentMonthValue, billPreiousMonthValue], depositCurrentValue, promotionCurrentValue,]) => {
        return res.status(200).send({
            sales: {
