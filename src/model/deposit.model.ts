...
import { ISalesInvoicePayment } from "./sales-invoice-payment.model";
...
export interface IDepositCode {
  ...
  date: Date;
  uuid: string;
  deposit: ISalesInvoice[];
  deposit_payment: ISalesInvoicePayment[];
  type: string;
  sales: string | null;
  is_delete?: boolean;
}
...
class DepositModel {
  ...
  constructor(data: any) {
    ...
    this.deposit_payment = data.deposit_payment || [];
    this.type = data.type;
