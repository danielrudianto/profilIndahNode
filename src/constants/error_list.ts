enum ErrorList {
  ...
  // Batas panjang mengikuti lebar kolom di basis data. Sebelumnya tidak ada
  // pemeriksaan panjang sama sekali, sehingga nilai yang terlalu panjang lolos
  // validasi lalu ditolak MySQL — pengguna menerima "Internal server error"
  // alih-alih penjelasan yang bisa ditindaklanjuti.
  // Ditulis sebagai kalimat utuh, bukan rakitan potongan, agar bisa
  // diterjemahkan sebagai satu kesatuan.
  "Supplier name too long" = "Nama supplier maksimal 100 karakter.",
  "Supplier NPWP too long" = "NPWP supplier maksimal 45 karakter.",
  "Customer name too long" = "Nama pelanggan maksimal 100 karakter.",
  "Customer PIC too long" = "Nama PIC pelanggan maksimal 100 karakter.",
  "Customer address too long" = "Alamat pelanggan maksimal 191 karakter.",
  "Company name too long" = "Nama perusahaan maksimal 50 karakter.",
  "Payment method name too long" = "Nama metode pembayaran maksimal 100 karakter.",
  "Brand name too long" = "Nama merek maksimal 45 karakter.",
  "Product type name too long" = "Nama tipe produk maksimal 45 karakter.",
  "Expense type name too long" = "Nama tipe pengeluaran maksimal 100 karakter.",
  "Product reference too long" = "Kode produk maksimal 50 karakter.",
  "Product description too long" = "Deskripsi produk maksimal 191 karakter.",
